...
class StateList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $col_id     = new TDataGridColumn('id', 'Cód.', 'left', '20%');
        ...
        $action1 = new TDataGridAction(['StateForm', 'onEdit'], ['key' => '{id}']);
        ...
        $panel = TPanelGroup::pack('Estados', $this->datagrid);
        $panel->addFooter($this->pageNavigation);

        $panel->addHeaderActionLink(_t('New'), new TAction(['StateForm', 'onEdit']), 'fa:plus green');
