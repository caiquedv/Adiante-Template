...
class UserList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->addFilterField('state', 'like', 'state');
        ...
        $col_name   = new TDataGridColumn('name', 'Nome', 'left', '30%');
        $col_email = new TDataGridColumn('email', 'E-mail', 'center', '30%');
        $col_state = new TDataGridColumn('stateObj->name', 'Estado', 'center', '20%');
        ...
        $action1 = new TDataGridAction(['UserForm', 'onEdit'], ['key' => '{id}']);
        ...
        $panel = TPanelGroup::pack('Usuários', $this->datagrid);
        $panel->addFooter($this->pageNavigation);

        $panel->addHeaderActionLink(_t('New'), new TAction(['UserForm', 'onEdit']), 'fa:plus green');
